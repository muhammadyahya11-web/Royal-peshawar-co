...
function List() {
  ...
  `${API_BASE}/product/productstatus/${id}`,
  {status:newStatus}, 
  {
    headers: {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Link
          to="/addproduct"
          className="flex items-center gap-2 bg-emerald-600 text-white px-5 py-2.5 rounded-lg hover:bg-emerald-700 transition text-sm font-medium"
        >
          <Plus size={18} />
          Add Product
        </Link>
